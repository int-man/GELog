...
# embeddings1 = model.encode(df['Event Explanation'].tolist())
# embeddings2 = model.encode(df1['Event Explanation'].tolist())

embeddings1 = model.encode(df['EventTemplate'].tolist())
embeddings2 = model.encode(df1['EventTemplate'].tolist())
...
plt.scatter(reduced_embeddings2[:, 0], reduced_embeddings2[:, 1], c='red', label='Unstable log templates')
...
plt.title('Impact of log evolution',fontsize=20)
plt.xlabel('Principal Component 1',fontsize=20)
plt.ylabel('Principal Component 2', fontsize=20)
plt.savefig('picture/EMPIRICAL STUDY/ImpactOfLogEvolution.pdf')
